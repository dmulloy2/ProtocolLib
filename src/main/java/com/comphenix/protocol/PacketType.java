...
public class PacketType implements Serializable, Cloneable, Comparable<PacketType> {
	...
	public static class Play {
		...
		public static class Server extends PacketTypeEnum {
			...
			public static final PacketType PLAYER_INFO =                  new PacketType(PROTOCOL, SENDER, 0x36, "PlayerInfoUpdate", "PlayerInfo", "SPacketPlayerListItem");
		...
		public static class Client extends PacketTypeEnum {
			...
			public static final PacketType POSITION =                     new PacketType(PROTOCOL, SENDER, 0x13, "Flying$Position", "Flying$PacketPlayInPosition", "CPacketPlayer$Position");
			public static final PacketType POSITION_LOOK =                new PacketType(PROTOCOL, SENDER, 0x14, "Flying$PositionLook", "Flying$PacketPlayInPositionLook", "CPacketPlayer$PositionRotation");
			public static final PacketType LOOK =                         new PacketType(PROTOCOL, SENDER, 0x15, "Flying$Look", "Flying$PacketPlayInLook", "CPacketPlayer$Rotation");
			public static final PacketType GROUND =                       new PacketType(PROTOCOL, SENDER, 0x16, "Flying$", "Flying$d");
