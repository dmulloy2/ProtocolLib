...
public class PacketType implements Serializable, Cloneable, Comparable<PacketType> {
    ...
    public static class Play {
        ...
        public static class Server extends PacketTypeEnum {
            ...
            public static final PacketType GAME_RULE_VALUES =             new PacketType(PROTOCOL, SENDER, 0x27, "GameRuleValues");
            public static final PacketType GAME_TEST_HIGHLIGHT_POS =      new PacketType(PROTOCOL, SENDER, 0x28, "GameTestHighlightPos");
            public static final PacketType OPEN_WINDOW_HORSE =            new PacketType(PROTOCOL, SENDER, 0x29, "MountScreenOpen", "HorseScreenOpen", "OpenWindowHorse");
            public static final PacketType HURT_ANIMATION =               new PacketType(PROTOCOL, SENDER, 0x2A, "HurtAnimation", "ClientboundHurtAnimationPacket");
            public static final PacketType INITIALIZE_BORDER =            new PacketType(PROTOCOL, SENDER, 0x2B, "InitializeBorder");
            public static final PacketType KEEP_ALIVE =                   new PacketType(PROTOCOL, SENDER, 0x2C, "KeepAlive", "SPacketKeepAlive");
            public static final PacketType MAP_CHUNK =                    new PacketType(PROTOCOL, SENDER, 0x2D, "LevelChunkWithLight", "MapChunk", "SPacketChunkData");
            public static final PacketType WORLD_EVENT =                  new PacketType(PROTOCOL, SENDER, 0x2E, "LevelEvent", "WorldEvent", "SPacketEffect");
            public static final PacketType WORLD_PARTICLES =              new PacketType(PROTOCOL, SENDER, 0x2F, "LevelParticles", "WorldParticles", "SPacketParticles");
            public static final PacketType LIGHT_UPDATE =                 new PacketType(PROTOCOL, SENDER, 0x30, "LightUpdate");
            public static final PacketType LOGIN =                        new PacketType(PROTOCOL, SENDER, 0x31, "Login", "SPacketJoinGame");
            public static final PacketType LOW_DISK_SPACE_WARNING =       new PacketType(PROTOCOL, SENDER, 0x32, "LowDiskSpaceWarning");
            public static final PacketType MAP =                          new PacketType(PROTOCOL, SENDER, 0x33, "MapItemData", "Map", "SPacketMaps");
            public static final PacketType OPEN_WINDOW_MERCHANT =         new PacketType(PROTOCOL, SENDER, 0x34, "MerchantOffers", "OpenWindowMerchant");
            public static final PacketType REL_ENTITY_MOVE =              new PacketType(PROTOCOL, SENDER, 0x35, "net.minecraft.network.protocol.game.ClientboundMoveEntityPacket$Pos", "Entity$RelEntityMove", "Entity$PacketPlayOutRelEntityMove");
            public static final PacketType REL_ENTITY_MOVE_LOOK =         new PacketType(PROTOCOL, SENDER, 0x36, "net.minecraft.network.protocol.game.ClientboundMoveEntityPacket$PosRot", "Entity$RelEntityMoveLook", "Entity$PacketPlayOutRelEntityMoveLook");
            public static final PacketType MOVE_MINECART =                new PacketType(PROTOCOL, SENDER, 0x37, "MoveMinecart");
            public static final PacketType ENTITY_LOOK =                  new PacketType(PROTOCOL, SENDER, 0x38, "net.minecraft.network.protocol.game.ClientboundMoveEntityPacket$Rot", "Entity$EntityLook", "Entity$PacketPlayOutEntityLook");
            public static final PacketType VEHICLE_MOVE =                 new PacketType(PROTOCOL, SENDER, 0x39, "MoveVehicle", "VehicleMove", "SPacketMoveVehicle");
            public static final PacketType OPEN_BOOK =                    new PacketType(PROTOCOL, SENDER, 0x3A, "OpenBook");
            public static final PacketType OPEN_WINDOW =                  new PacketType(PROTOCOL, SENDER, 0x3B, "OpenScreen", "OpenWindow", "SPacketOpenWindow");
            public static final PacketType OPEN_SIGN_EDITOR =             new PacketType(PROTOCOL, SENDER, 0x3C, "OpenSignEditor", "SPacketSignEditorOpen");
            public static final PacketType PING =                         new PacketType(PROTOCOL, SENDER, 0x3D, "Ping");
            public static final PacketType PONG_RESPONSE =                new PacketType(PROTOCOL, SENDER, 0x3E, "PongResponse");
            public static final PacketType AUTO_RECIPE =                  new PacketType(PROTOCOL, SENDER, 0x3F, "PlaceGhostRecipe", "AutoRecipe", "SPacketPlaceGhostRecipe");
            public static final PacketType ABILITIES =                    new PacketType(PROTOCOL, SENDER, 0x40, "PlayerAbilities", "Abilities", "SPacketPlayerAbilities");
            public static final PacketType CHAT =                         new PacketType(PROTOCOL, SENDER, 0x41, "PlayerChat", "Chat", "SPacketChat");
            public static final PacketType PLAYER_COMBAT_END =            new PacketType(PROTOCOL, SENDER, 0x42, "PlayerCombatEnd");
            public static final PacketType PLAYER_COMBAT_ENTER =          new PacketType(PROTOCOL, SENDER, 0x43, "PlayerCombatEnter");
            public static final PacketType PLAYER_COMBAT_KILL =           new PacketType(PROTOCOL, SENDER, 0x44, "PlayerCombatKill");
            public static final PacketType PLAYER_INFO_REMOVE =           new PacketType(PROTOCOL, SENDER, 0x45, "PlayerInfoRemove");
            public static final PacketType PLAYER_INFO =                  new PacketType(PROTOCOL, SENDER, 0x46, "PlayerInfoUpdate", "PlayerInfo");
            public static final PacketType LOOK_AT =                      new PacketType(PROTOCOL, SENDER, 0x47, "PlayerLookAt", "LookAt", "SPacketPlayerPosLook");
            public static final PacketType POSITION =                     new PacketType(PROTOCOL, SENDER, 0x48, "PlayerPosition", "Position");
            public static final PacketType PLAYER_ROTATION =              new PacketType(PROTOCOL, SENDER, 0x49, "PlayerRotation");
            public static final PacketType RECIPE_BOOK_ADD =              new PacketType(PROTOCOL, SENDER, 0x4A, "RecipeBookAdd");
            public static final PacketType RECIPE_BOOK_REMOVE =           new PacketType(PROTOCOL, SENDER, 0x4B, "RecipeBookRemove");
            public static final PacketType RECIPE_BOOK_SETTINGS =         new PacketType(PROTOCOL, SENDER, 0x4C, "RecipeBookSettings");
            public static final PacketType ENTITY_DESTROY =               new PacketType(PROTOCOL, SENDER, 0x4D, "RemoveEntities", "EntityDestroy", "SPacketDestroyEntities");
            public static final PacketType REMOVE_ENTITY_EFFECT =         new PacketType(PROTOCOL, SENDER, 0x4E, "RemoveMobEffect", "RemoveEntityEffect", "SPacketRemoveEntityEffect");
            public static final PacketType RESET_SCORE =                  new PacketType(PROTOCOL, SENDER, 0x4F, "ResetScore", "ResetScorePacket");
            public static final PacketType REMOVE_RESOURCE_PACK =         new PacketType(PROTOCOL, SENDER, 0x50, "ResourcePackPop", "ResourcePackPopPacket");
            public static final PacketType ADD_RESOURCE_PACK =            new PacketType(PROTOCOL, SENDER, 0x51, "ResourcePackPush", "ResourcePackPushPacket");
            public static final PacketType RESPAWN =                      new PacketType(PROTOCOL, SENDER, 0x52, "Respawn", "SPacketRespawn");
            public static final PacketType ENTITY_HEAD_ROTATION =         new PacketType(PROTOCOL, SENDER, 0x53, "RotateHead", "EntityHeadRotation", "SPacketEntityHeadLook");
            public static final PacketType MULTI_BLOCK_CHANGE =           new PacketType(PROTOCOL, SENDER, 0x54, "SectionBlocksUpdate", "MultiBlockChange", "SPacketMultiBlockChange");
            public static final PacketType SELECT_ADVANCEMENT_TAB =       new PacketType(PROTOCOL, SENDER, 0x55, "SelectAdvancementsTab", "SelectAdvancementTab", "SPacketSelectAdvancementsTab");
            public static final PacketType SERVER_DATA =                  new PacketType(PROTOCOL, SENDER, 0x56, "ServerData");
            public static final PacketType SET_ACTION_BAR_TEXT =          new PacketType(PROTOCOL, SENDER, 0x57, "SetActionBarText");
            public static final PacketType SET_BORDER_CENTER =            new PacketType(PROTOCOL, SENDER, 0x58, "SetBorderCenter");
            public static final PacketType SET_BORDER_LERP_SIZE =         new PacketType(PROTOCOL, SENDER, 0x59, "SetBorderLerpSize");
            public static final PacketType SET_BORDER_SIZE =              new PacketType(PROTOCOL, SENDER, 0x5A, "SetBorderSize");
            public static final PacketType SET_BORDER_WARNING_DELAY =     new PacketType(PROTOCOL, SENDER, 0x5B, "SetBorderWarningDelay");
            public static final PacketType SET_BORDER_WARNING_DISTANCE =  new PacketType(PROTOCOL, SENDER, 0x5C, "SetBorderWarningDistance");
            public static final PacketType CAMERA =                       new PacketType(PROTOCOL, SENDER, 0x5D, "SetCamera", "Camera", "SPacketCamera");
            public static final PacketType VIEW_CENTRE =                  new PacketType(PROTOCOL, SENDER, 0x5E, "SetChunkCacheCenter", "ViewCentre");
            public static final PacketType VIEW_DISTANCE =                new PacketType(PROTOCOL, SENDER, 0x5F, "SetChunkCacheRadius", "ViewDistance");
            public static final PacketType SET_CURSOR_ITEM =              new PacketType(PROTOCOL, SENDER, 0x60, "SetCursorItem");
            public static final PacketType SPAWN_POSITION =               new PacketType(PROTOCOL, SENDER, 0x61, "SetDefaultSpawnPosition", "SpawnPosition", "SPacketSpawnPosition");
            public static final PacketType SCOREBOARD_DISPLAY_OBJECTIVE = new PacketType(PROTOCOL, SENDER, 0x62, "SetDisplayObjective", "ScoreboardDisplayObjective", "SPacketDisplayObjective");
            public static final PacketType ENTITY_METADATA =              new PacketType(PROTOCOL, SENDER, 0x63, "SetEntityData", "EntityMetadata", "SPacketEntityMetadata");
            public static final PacketType ATTACH_ENTITY =                new PacketType(PROTOCOL, SENDER, 0x64, "SetEntityLink", "AttachEntity", "SPacketEntityAttach");
            public static final PacketType ENTITY_VELOCITY =              new PacketType(PROTOCOL, SENDER, 0x65, "SetEntityMotion", "EntityVelocity", "SPacketEntityVelocity");
            public static final PacketType ENTITY_EQUIPMENT =             new PacketType(PROTOCOL, SENDER, 0x66, "SetEquipment", "EntityEquipment", "SPacketEntityEquipment");
            public static final PacketType EXPERIENCE =                   new PacketType(PROTOCOL, SENDER, 0x67, "SetExperience", "Experience", "SPacketSetExperience");
            public static final PacketType UPDATE_HEALTH =                new PacketType(PROTOCOL, SENDER, 0x68, "SetHealth", "UpdateHealth", "SPacketUpdateHealth");
            public static final PacketType HELD_ITEM_SLOT =               new PacketType(PROTOCOL, SENDER, 0x69, "SetHeldSlot", "SetCarriedItem", "HeldItemSlot", "SPacketHeldItemChange");
            public static final PacketType SCOREBOARD_OBJECTIVE =         new PacketType(PROTOCOL, SENDER, 0x6A, "SetObjective", "ScoreboardObjective", "SPacketScoreboardObjective");
            public static final PacketType MOUNT =                        new PacketType(PROTOCOL, SENDER, 0x6B, "SetPassengers", "Mount", "SPacketSetPassengers");
            public static final PacketType SET_PLAYER_INVENTORY =         new PacketType(PROTOCOL, SENDER, 0x6C, "SetPlayerInventory");
            public static final PacketType SCOREBOARD_TEAM =              new PacketType(PROTOCOL, SENDER, 0x6D, "SetPlayerTeam", "ScoreboardTeam", "SPacketTeams");
            public static final PacketType SCOREBOARD_SCORE =             new PacketType(PROTOCOL, SENDER, 0x6E, "SetScore", "ScoreboardScore", "SPacketUpdateScore");
            public static final PacketType UPDATE_SIMULATION_DISTANCE =   new PacketType(PROTOCOL, SENDER, 0x6F, "SetSimulationDistance");
            public static final PacketType SET_SUBTITLE_TEXT =            new PacketType(PROTOCOL, SENDER, 0x70, "SetSubtitleText");
            public static final PacketType UPDATE_TIME =                  new PacketType(PROTOCOL, SENDER, 0x71, "SetTime", "UpdateTime", "SPacketTimeUpdate");
            public static final PacketType SET_TITLE_TEXT =               new PacketType(PROTOCOL, SENDER, 0x72, "SetTitleText");
            public static final PacketType SET_TITLES_ANIMATION =         new PacketType(PROTOCOL, SENDER, 0x73, "SetTitlesAnimation");
            public static final PacketType ENTITY_SOUND =                 new PacketType(PROTOCOL, SENDER, 0x74, "SoundEntity", "EntitySound", "SPacketSoundEffect");
            public static final PacketType NAMED_SOUND_EFFECT =           new PacketType(PROTOCOL, SENDER, 0x75, "Sound", "NamedSoundEffect");
            public static final PacketType START_CONFIGURATION =          new PacketType(PROTOCOL, SENDER, 0x76, "StartConfiguration");
            public static final PacketType STOP_SOUND =                   new PacketType(PROTOCOL, SENDER, 0x77, "StopSound");
            public static final PacketType STORE_COOKIE =                 new PacketType(PROTOCOL, SENDER, 0x78, "StoreCookie");
            public static final PacketType SYSTEM_CHAT =                  new PacketType(PROTOCOL, SENDER, 0x79, "SystemChat");
            public static final PacketType PLAYER_LIST_HEADER_FOOTER =    new PacketType(PROTOCOL, SENDER, 0x7A, "TabList", "PlayerListHeaderFooter", "SPacketPlayerListHeaderFooter");
            public static final PacketType NBT_QUERY =                    new PacketType(PROTOCOL, SENDER, 0x7B, "TagQuery", "NBTQuery");
            public static final PacketType COLLECT =                      new PacketType(PROTOCOL, SENDER, 0x7C, "TakeItemEntity", "Collect", "SPacketCollectItem");
            public static final PacketType ENTITY_TELEPORT =              new PacketType(PROTOCOL, SENDER, 0x7D, "TeleportEntity", "EntityTeleport", "SPacketEntityTeleport");
            public static final PacketType TEST_INSTANCE_BLOCK_STATUS =   new PacketType(PROTOCOL, SENDER, 0x7E, "ClientboundTestInstanceBlockStatus");
            public static final PacketType TICKING_STATE =                new PacketType(PROTOCOL, SENDER, 0x7F, "TickingState", "TickingStatePacket");
            public static final PacketType TICKING_STEP_STATE =           new PacketType(PROTOCOL, SENDER, 0x80, "TickingStep", "TickingStepPacket");
            public static final PacketType TRANSFER =                     new PacketType(PROTOCOL, SENDER, 0x81, "Transfer");
            public static final PacketType ADVANCEMENTS =                 new PacketType(PROTOCOL, SENDER, 0x82, "UpdateAdvancements", "Advancements", "SPacketAdvancementInfo");
            public static final PacketType UPDATE_ATTRIBUTES =            new PacketType(PROTOCOL, SENDER, 0x83, "UpdateAttributes", "SPacketEntityProperties");
            public static final PacketType ENTITY_EFFECT =                new PacketType(PROTOCOL, SENDER, 0x84, "UpdateMobEffect", "EntityEffect", "SPacketEntityEffect");
            public static final PacketType RECIPE_UPDATE =                new PacketType(PROTOCOL, SENDER, 0x85, "UpdateRecipes", "RecipeUpdate");
            public static final PacketType TAGS =                         new PacketType(PROTOCOL, SENDER, 0x86, "UpdateTags", "Tags");
            public static final PacketType PROJECTILE_POWER =             new PacketType(PROTOCOL, SENDER, 0x87, "ProjectilePower");
            public static final PacketType REPORT_DETAILS =               new PacketType(PROTOCOL, SENDER, 0x88, "CustomReportDetails");
            public static final PacketType SERVER_LINKS =                 new PacketType(PROTOCOL, SENDER, 0x89, "ServerLinks");
            public static final PacketType TRACKED_WAYPOINT =             new PacketType(PROTOCOL, SENDER, 0x8A, "TrackedWaypoint");
            public static final PacketType CLEAR_DIALOG =                 new PacketType(PROTOCOL, SENDER, 0x8B, "ClearDialog");
            public static final PacketType SHOW_DIALOG =                  new PacketType(PROTOCOL, SENDER, 0x8C, "ShowDialog");
        ...
        public static class Client extends PacketTypeEnum {
            ...
            public static final PacketType RECIPE_SETTINGS =              new PacketType(PROTOCOL, SENDER, 0x2E, "RecipeBookChangeSettings", "RecipeSettings");
            public static final PacketType RECIPE_DISPLAYED =             new PacketType(PROTOCOL, SENDER, 0x2F, "RecipeBookSeenRecipe", "RecipeDisplayed", "CPacketRecipeInfo");
            public static final PacketType ITEM_NAME =                    new PacketType(PROTOCOL, SENDER, 0x30, "RenameItem", "ItemName");
            public static final PacketType RESOURCE_PACK_STATUS =         new PacketType(PROTOCOL, SENDER, 0x31, "ResourcePack", "ResourcePackStatus", "CPacketResourcePackStatus");
            public static final PacketType ADVANCEMENTS =                 new PacketType(PROTOCOL, SENDER, 0x32, "SeenAdvancements", "Advancements", "CPacketSeenAdvancements");
            public static final PacketType TR_SEL =                       new PacketType(PROTOCOL, SENDER, 0x33, "SelectTrade", "TrSel");
            public static final PacketType BEACON =                       new PacketType(PROTOCOL, SENDER, 0x34, "SetBeacon", "Beacon");
            public static final PacketType HELD_ITEM_SLOT =               new PacketType(PROTOCOL, SENDER, 0x35, "SetCarriedItem", "HeldItemSlot", "CPacketHeldItemChange");
            public static final PacketType SET_COMMAND_BLOCK =            new PacketType(PROTOCOL, SENDER, 0x36, "SetCommandBlock");
            public static final PacketType SET_COMMAND_MINECART =         new PacketType(PROTOCOL, SENDER, 0x37, "SetCommandMinecart");
            public static final PacketType SET_CREATIVE_SLOT =            new PacketType(PROTOCOL, SENDER, 0x38, "SetCreativeModeSlot", "SetCreativeSlot", "CPacketCreativeInventoryAction");
            public static final PacketType SET_GAME_RULE =                new PacketType(PROTOCOL, SENDER, 0x39, "SetGameRule");
            public static final PacketType SET_JIGSAW =                   new PacketType(PROTOCOL, SENDER, 0x3A, "SetJigsawBlock", "SetJigsaw");
