...
public class PacketType implements Serializable, Cloneable, Comparable<PacketType> {
	...
	public static class Play {
		...
		public static class Server extends PacketTypeEnum {
			...
			public static final PacketType MAP_CHUNK =                    new PacketType(PROTOCOL, SENDER, 0x20, "MapChunk", "SPacketChunkData", "LevelChunkWithLight");
			...
			public static final PacketType REL_ENTITY_MOVE =              new PacketType(PROTOCOL, SENDER, 0x27, "Entity$PacketPlayOutRelEntityMove", "Entity$RelEntityMove");
			public static final PacketType REL_ENTITY_MOVE_LOOK =         new PacketType(PROTOCOL, SENDER, 0x28, "Entity$PacketPlayOutRelEntityMoveLook", "Entity$RelEntityMoveLook");
			public static final PacketType ENTITY_LOOK =                  new PacketType(PROTOCOL, SENDER, 0x29, "Entity$PacketPlayOutEntityLook", "Entity$EntityLook");
			...
			public static final PacketType PLAYER_INFO =                  new PacketType(PROTOCOL, SENDER, 0x35, "PlayerInfo", "SPacketPlayerListItem");
			public static final PacketType LOOK_AT =                      new PacketType(PROTOCOL, SENDER, 0x36, "LookAt", "SPacketPlayerPosLook");
			public static final PacketType POSITION =                     new PacketType(PROTOCOL, SENDER, 0x37, "Position");
			public static final PacketType RECIPES =                      new PacketType(PROTOCOL, SENDER, 0x38, "Recipes", "SPacketRecipeBook");
			public static final PacketType ENTITY_DESTROY =               new PacketType(PROTOCOL, SENDER, 0x39, "EntityDestroy", "SPacketDestroyEntities");
			public static final PacketType REMOVE_ENTITY_EFFECT =         new PacketType(PROTOCOL, SENDER, 0x3A, "RemoveEntityEffect", "SPacketRemoveEntityEffect");
			public static final PacketType RESOURCE_PACK_SEND =           new PacketType(PROTOCOL, SENDER, 0x3B, "ResourcePackSend", "SPacketResourcePackSend");
			public static final PacketType RESPAWN =                      new PacketType(PROTOCOL, SENDER, 0x3C, "Respawn", "SPacketRespawn");
			public static final PacketType ENTITY_HEAD_ROTATION =         new PacketType(PROTOCOL, SENDER, 0x3D, "EntityHeadRotation", "SPacketEntityHeadLook");
			public static final PacketType MULTI_BLOCK_CHANGE =           new PacketType(PROTOCOL, SENDER, 0x3E, "MultiBlockChange", "SPacketMultiBlockChange");
			public static final PacketType SELECT_ADVANCEMENT_TAB =       new PacketType(PROTOCOL, SENDER, 0x3F, "SelectAdvancementTab", "SPacketSelectAdvancementsTab");
			public static final PacketType SERVER_DATA =                  new PacketType(PROTOCOL, SENDER, 0x40, "ServerData");
			...
			public static final PacketType SET_DISPLAY_CHAT_PREVIEW =     new PacketType(PROTOCOL, SENDER, 0x4C, "SetDisplayChatPreview");
			...
			public static final PacketType ENTITY_EFFECT =                new PacketType(PROTOCOL, SENDER, 0x67, "EntityEffect", "SPacketEntityEffect");
			public static final PacketType RECIPE_UPDATE =                new PacketType(PROTOCOL, SENDER, 0x68, "RecipeUpdate");
			public static final PacketType TAGS =                         new PacketType(PROTOCOL, SENDER, 0x69, "Tags");
