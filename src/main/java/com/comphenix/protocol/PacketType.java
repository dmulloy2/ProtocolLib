...
public class PacketType implements Serializable, Cloneable, Comparable<PacketType> {
	...
	public static class Play {
		...
		public static class Server extends PacketTypeEnum {
			...
			public static final PacketType CHUNKS_BIOMES =                new PacketType(PROTOCOL, SENDER, 0x0D, "ChunksBiomes");
			...
			public static final PacketType DAMAGE_EVENT =                 new PacketType(PROTOCOL, SENDER, 0x18, "DamageEvent");
			...
			public static final PacketType HURT_ANIMATION =               new PacketType(PROTOCOL, SENDER, 0x21, "HurtAnimation");
