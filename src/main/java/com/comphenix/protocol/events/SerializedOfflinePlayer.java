...
class SerializedOfflinePlayer implements Serializable {
    ...
    public Player getProxyPlayer() {
        try {
            return (Player) proxyPlayerConstructor.newInstance(this.createOfflinePlayerProxy());
    ...
    private OfflinePlayer createOfflinePlayerProxy() {
                ...
                (proxy, method, arguments) -> {
                    if (method.getDeclaringClass() == Object.class) {
                        return switch (method.getName()) {
                            ...
                            case "toString" -> "SerializedOfflinePlayer[" + this.name + "]";
                            default -> throw new UnsupportedOperationException("Unsupported Object method " + method);
                        };
                    }

                    try {
                        Method target = SerializedOfflinePlayer.class.getMethod(
                                method.getName(),
                                method.getParameterTypes());
                        return target.invoke(this, arguments);
