...
public class PacketContainer implements Serializable {
	...
	private static final AggregateCloner DEEP_CLONER = AggregateCloner.newBuilder().instanceProvider(DefaultInstances.DEFAULT).andThen(BukkitCloner.class).andThen(ImmutableDetector.class).andThen(JavaOptionalCloner.class).andThen(GuavaOptionalCloner.class).andThen(CollectionCloner.class).andThen(getSpecializedDeepClonerFactory()).build();
	
	private static final AggregateCloner SHALLOW_CLONER = AggregateCloner.newBuilder().instanceProvider(DefaultInstances.DEFAULT).andThen(param -> {
		if (param == null) throw new IllegalArgumentException("Cannot be NULL.");
	...
	private static final Set<PacketType> CLONING_UNSUPPORTED = Sets.newHashSet(PacketType.Play.Server.UPDATE_ATTRIBUTES, PacketType.Status.Server.SERVER_INFO);
	...
	public StructureModifier<ItemStack> getItemModifier() {
		...
		return structureModifier.withType(MinecraftReflection.getItemStackClass(), BukkitConverters.getItemStackConverter());
	}
	...
	public StructureModifier<ItemStack[]> getItemArrayModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getItemStackArrayClass(), Converters.ignoreNull(new ItemStackArrayConverter()));
	}
	...
	public StructureModifier<List<ItemStack>> getItemListModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(List.class, BukkitConverters.getListConverter(BukkitConverters.getItemStackConverter()));
	}
	...
	public StructureModifier<WorldType> getWorldTypeModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getWorldTypeClass(), BukkitConverters.getWorldTypeConverter());
	}
	...
	public StructureModifier<WrappedDataWatcher> getDataWatcherModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getDataWatcherClass(), BukkitConverters.getDataWatcherConverter());
	}
	...
	public StructureModifier<Entity> getEntityModifier(@Nonnull World world) {
		...
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(int.class, BukkitConverters.getEntityConverter(world));
	}
	...
	public StructureModifier<EntityType> getEntityTypeModifier() {
		return structureModifier.withType(MinecraftReflection.getMinecraftClass("EntityTypes"), BukkitConverters.getEntityTypeConverter());
	}
	...
	public StructureModifier<ChunkPosition> getPositionModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getChunkPositionClass(), ChunkPosition.getConverter());
	}
	...
	public StructureModifier<BlockPosition> getBlockPositionModifier() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getBlockPositionClass(), BlockPosition.getConverter());
	}
	...
	public StructureModifier<ChunkCoordIntPair> getChunkCoordIntPairs() {
		...
		return structureModifier.withType(MinecraftReflection.getChunkCoordIntPair(), ChunkCoordIntPair.getConverter());
	}
	...
	public StructureModifier<NbtBase<?>> getNbtModifier() {
		// Allow access to the NBT class in packet 130
		return structureModifier.withType(MinecraftReflection.getNBTBaseClass(), BukkitConverters.getNbtConverter());
	}
	...
	public StructureModifier<List<NbtBase<?>>> getListNbtModifier() {
		...
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(BukkitConverters.getNbtConverter()));
	}
	...
	public StructureModifier<Vector> getVectors() {
		...
		return structureModifier.withType(MinecraftReflection.getVec3DClass(), BukkitConverters.getVectorConverter());
	}
	...
	public StructureModifier<List<WrappedAttribute>> getAttributeCollectionModifier() {
		// Convert to and from the ProtocolLib wrapper
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(BukkitConverters.getWrappedAttributeConverter()));
	}
	
	/**
	 * Retrieves a read/write structure for collections of chunk positions.
	 * <p>
	 * This modifier will automatically marshal between the visible ProtocolLib ChunkPosition and the internal Minecraft ChunkPosition.
	 * 
	 * @return A modifier for ChunkPosition list fields.
	 */
	public StructureModifier<List<ChunkPosition>> getPositionCollectionModifier() {
		// Convert to and from the ProtocolLib wrapper
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(ChunkPosition.getConverter()));
	}
	...
	public StructureModifier<List<BlockPosition>> getBlockPositionCollectionModifier() {
		// Convert to and from the ProtocolLib wrapper
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(BlockPosition.getConverter()));
	}
	...
	public StructureModifier<List<WrappedWatchableObject>> getWatchableCollectionModifier() {
		// Convert to and from the ProtocolLib wrapper
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(BukkitConverters.getWatchableObjectConverter()));
	}
	...
	public StructureModifier<Material> getBlocks() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getBlockClass(), BukkitConverters.getBlockConverter());
	}
	...
	public StructureModifier<WrappedGameProfile> getGameProfiles() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getGameProfileClass(), BukkitConverters.getWrappedGameProfileConverter());
	}
	...
	public StructureModifier<WrappedBlockData> getBlockData() {
		...
		return structureModifier.withType(MinecraftReflection.getIBlockDataClass(), BukkitConverters.getWrappedBlockDataConverter());
	}
	...
	public StructureModifier<WrappedBlockData[]> getBlockDataArrays() {
		...
		return structureModifier.withType(MinecraftReflection.getArrayClass(MinecraftReflection.getIBlockDataClass()), Converters.array(MinecraftReflection.getIBlockDataClass(), BukkitConverters.getWrappedBlockDataConverter()));
	}
	...
	public StructureModifier<MultiBlockChangeInfo[]> getMultiBlockChangeInfoArrays() {
		...
		// Convert to and from our wrapper
		return structureModifier.withType(MinecraftReflection.getMultiBlockChangeInfoArrayClass(), Converters.array(MinecraftReflection.getMultiBlockChangeInfoClass(), MultiBlockChangeInfo.getConverter(chunk)));
	}
	...
	public StructureModifier<WrappedChatComponent> getChatComponents() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(MinecraftReflection.getIChatBaseComponentClass(), BukkitConverters.getWrappedChatComponentConverter());
	}
	...
	public StructureModifier<WrappedChatComponent[]> getChatComponentArrays() {
		// Convert to and from the Bukkit wrapper
		return structureModifier.withType(ComponentArrayConverter.getGenericType(), Converters.ignoreNull(new ComponentArrayConverter()));
	}
	...
	public StructureModifier<WrappedServerPing> getServerPings() {
		...
		return structureModifier.withType(MinecraftReflection.getServerPingClass(), BukkitConverters.getWrappedServerPingConverter());
	}
	...
	public StructureModifier<List<PlayerInfoData>> getPlayerInfoDataLists() {
		// Convert to and from the ProtocolLib wrapper
		return structureModifier.withType(Collection.class, BukkitConverters.getListConverter(PlayerInfoData.getConverter()));
	}
	...
	public StructureModifier<Protocol> getProtocols() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getProtocolClass(), EnumWrappers.getProtocolConverter());
	}
	...
	public StructureModifier<ChatVisibility> getChatVisibilities() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getChatVisibilityClass(), EnumWrappers.getChatVisibilityConverter());
	}
	...
	public StructureModifier<Difficulty> getDifficulties() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getDifficultyClass(), EnumWrappers.getDifficultyConverter());
	}
	...
	public StructureModifier<EntityUseAction> getEntityUseActions() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getEntityUseActionClass(), EnumWrappers.getEntityUseActionConverter());
	}
	...
	public StructureModifier<NativeGameMode> getGameModes() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getGameModeClass(), EnumWrappers.getGameModeConverter());
	}
	...
	public StructureModifier<PlayerInfoAction> getPlayerInfoAction() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getPlayerInfoActionClass(), EnumWrappers.getPlayerInfoActionConverter());
	}
	...
	public StructureModifier<TitleAction> getTitleActions() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getTitleActionClass(), EnumWrappers.getTitleActionConverter());
	}
	...
	public StructureModifier<WorldBorderAction> getWorldBorderActions() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getWorldBorderActionClass(), EnumWrappers.getWorldBorderActionConverter());
	}
	...
	public StructureModifier<CombatEventType> getCombatEvents() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getCombatEventTypeClass(), EnumWrappers.getCombatEventTypeConverter());
	}
	...
	public StructureModifier<PlayerDigType> getPlayerDigTypes() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getPlayerDigTypeClass(), EnumWrappers.getPlayerDiggingActionConverter());
	}
	...
	public StructureModifier<PlayerAction> getPlayerActions() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getPlayerActionClass(), EnumWrappers.getEntityActionConverter());
	}
	...
	public StructureModifier<ScoreboardAction> getScoreboardActions() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getScoreboardActionClass(), EnumWrappers.getUpdateScoreActionConverter());
	}
	
	/**
	 * Retrieve a read/write structure for the Particle enum in 1.8-1.12. <b>NOTE:</b> This will produce undesirable results in 1.13
	 * 
	 * @return A modifier for Particle enum fields.
	 */
	public StructureModifier<EnumWrappers.Particle> getParticles() {
		// Convert to and from the wrapper
		return structureModifier.withType(EnumWrappers.getParticleClass(), EnumWrappers.getParticleConverter());
	}
	...
	public StructureModifier<WrappedParticle> getNewParticles() {
		return structureModifier.withType(MinecraftReflection.getMinecraftClass("ParticleParam"), BukkitConverters.getParticleConverter());
	}
	...
	public StructureModifier<PotionEffectType> getEffectTypes() {
		...
		return structureModifier.withType(MinecraftReflection.getMobEffectListClass(), BukkitConverters.getEffectTypeConverter());
	}
	...
	public StructureModifier<SoundCategory> getSoundCategories() {
		...
		return structureModifier.withType(EnumWrappers.getSoundCategoryClass(), EnumWrappers.getSoundCategoryConverter());
	}
	...
	public StructureModifier<Sound> getSoundEffects() {
		// Convert to and from Bukkit
		return structureModifier.withType(MinecraftReflection.getSoundEffectClass(), BukkitConverters.getSoundConverter());
	}
	...
	public StructureModifier<ItemSlot> getItemSlots() {
		return structureModifier.withType(EnumWrappers.getItemSlotClass(), EnumWrappers.getItemSlotConverter());
	}
	...
	public StructureModifier<Direction> getDirections() {
		return structureModifier.withType(EnumWrappers.getDirectionClass(), EnumWrappers.getDirectionConverter());
	}
	...
	public StructureModifier<MinecraftKey> getMinecraftKeys() {
		return structureModifier.withType(MinecraftReflection.getMinecraftKeyClass(), MinecraftKey.getConverter());
	}
	
	/**
	 * Retrieve a read/write structure for the ResourceKey class.
	 * 
	 * @return A modifier for ResourceKey fields.
	 */
	public StructureModifier<ResourceKey> getResourceKeys() {
		return structureModifier.withType(MinecraftReflection.getResourceKeyClass(), ResourceKey.getConverter());
	}
	...
	public StructureModifier<Integer> getDimensions() {
		if (MinecraftVersion.NETHER_UPDATE.atOrAbove() && !MinecraftVersion.NETHER_UPDATE_2.atOrAbove()) {
			return structureModifier.withParamType(MinecraftReflection.getResourceKeyClass(), BukkitConverters.getDimensionIDConverter(), MinecraftReflection.getMinecraftClass("DimensionManager"));
		}
		else {
			return structureModifier.withType(MinecraftReflection.getMinecraftClass("DimensionManager"), BukkitConverters.getDimensionIDConverter());
		}
	}
	...
	public StructureModifier<List<MerchantRecipe>> getMerchantRecipeLists() {
		return structureModifier.withType(MinecraftReflection.getMinecraftClass("MerchantRecipeList"), BukkitConverters.getMerchantRecipeListConverter());
	}
	...
	public StructureModifier<List<Pair<ItemSlot, ItemStack>>> getSlotStackPairLists() {
		return getLists(BukkitConverters.getPairConverter(EnumWrappers.getItemSlotConverter(), BukkitConverters.getItemStackConverter()));
	}
	...
	public StructureModifier<MovingObjectPositionBlock> getMovingBlockPositions() {
		return structureModifier.withType(MovingObjectPositionBlock.getNmsClass(), MovingObjectPositionBlock.getConverter());
	}
	...
	public StructureModifier<World> getWorldKeys() {
		return structureModifier.withParamType(MinecraftReflection.getResourceKeyClass(), BukkitConverters.getWorldKeyConverter(), MinecraftReflection.getNmsWorldClass());
	}
	...
	public StructureModifier<BlockPosition> getSectionPositions() {
		return structureModifier.withType(MinecraftReflection.getMinecraftClass("SectionPosition"), BukkitConverters.getSectionPositionConverter());
	}
	...
	public <K, V> StructureModifier<Map<K, V>> getMaps(EquivalentConverter<K> keyConverter, EquivalentConverter<V> valConverter) {
		return structureModifier.withType(Map.class, BukkitConverters.getMapConverter(keyConverter, valConverter));
	}
	...
	public <E> StructureModifier<Set<E>> getSets(EquivalentConverter<E> converter) {
		return structureModifier.withType(Set.class, BukkitConverters.getSetConverter(converter));
	}
	...
	public <E> StructureModifier<List<E>> getLists(EquivalentConverter<E> converter) {
		return structureModifier.withType(List.class, BukkitConverters.getListConverter(converter));
	}
	...
	public <T extends Enum<T>> StructureModifier<T> getEnumModifier(Class<T> enumClass, Class<?> nmsClass) {
		return structureModifier.withType(nmsClass, new EnumConverter<>(nmsClass, enumClass));
	}
	
	/**
	 * Retrieve a read/write structure for an enum. This method is for convenience, see {@link #getEnumModifier(Class, Class)} for more information.
	 * 
	 * @param enumClass The specific Enum class
				...
				return new FieldCloner(param.getAggregateCloner(), param.getInstanceProvider()) {
					{
						this.writer = new ObjectWriter() {
							...
							protected void transformField(StructureModifier<Object> modifierSource, StructureModifier<Object> modifierDest, int fieldIndex) {
								...
								if (modifierSource.getField(fieldIndex).getName().startsWith("inflatedBuffer")) modifierDest.write(fieldIndex, modifierSource.read(fieldIndex));
								else
	...
	private void writeObject(ObjectOutputStream output) throws IOException {
		...
		try {
			if (MinecraftReflection.isUsingNetty()) {
				...
				output.writeInt(-1);
				getMethodLazily(writeMethods, handle.getClass(), "write", DataOutput.class).invoke(handle, new DataOutputStream(output));
			}
		...
		if (input.readBoolean()) {
			...
			try {
				if (MinecraftReflection.isUsingNetty()) {
					...
					if (input.readInt() != -1) throw new IllegalArgumentException("Cannot load a packet from 1.7.2 in 1.6.4.");
					
					getMethodLazily(readMethods, handle.getClass(), "read", DataInput.class).invoke(handle, new DataInputStream(input));
				}
			}
			catch (IllegalArgumentException e) {
