...
/**
 * Wrapper for {@code ClientboundCookieRequestPacket} (login phase, clientbound).
 *
 * <p>Packet structure:
 * <ul>
...
public class WrappedClientboundCookieRequestPacket extends AbstractPacket {
    ...
    public static final PacketType TYPE = PacketType.Login.Server.COOKIE_REQUEST;
    ...
    public WrappedClientboundCookieRequestPacket(MinecraftKey key) {
        this(PacketContainer.fromPacket(CONSTRUCTOR.create(key)));
    }
