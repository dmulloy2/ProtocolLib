...
/**
 * Wrapper for {@code ClientboundTransferPacket} (configuration phase, clientbound).
 */
public class WrappedClientboundTransferPacket extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Configuration.Server.TRANSFER;
    ...
    public WrappedClientboundTransferPacket(String host, int port) {
        this(new PacketContainer(TYPE, CONSTRUCTOR.create(host, port)));
    }
