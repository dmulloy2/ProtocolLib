...
/**
 * Wrapper for {@code ClientboundResourcePackPushPacket} (configuration phase, clientbound).
 */
public class WrappedClientboundResourcePackPushPacket extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Configuration.Server.ADD_RESOURCE_PACK;
