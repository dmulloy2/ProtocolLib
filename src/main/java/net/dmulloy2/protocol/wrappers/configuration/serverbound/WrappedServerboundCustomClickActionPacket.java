...
/**
 * Wrapper for {@code ServerboundCustomClickActionPacket} (configuration phase, serverbound).
 *
...
public class WrappedServerboundCustomClickActionPacket extends AbstractPacket {
    ...
    public static final PacketType TYPE = PacketType.Configuration.Client.CUSTOM_CLICK_ACTION;
    ...
    public WrappedServerboundCustomClickActionPacket(MinecraftKey id, Optional<NbtBase<?>> payload) {
        this(new PacketContainer(TYPE, CONSTRUCTOR.create(id, payload)));
    }
