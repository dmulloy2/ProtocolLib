...
/**
 * Wrapper for {@code ClientboundStoreCookiePacket} (configuration phase, clientbound).
 *
 * <p>Packet structure:
 * <ul>
...
public class WrappedClientboundStoreCookiePacket extends AbstractPacket {
    ...
    public static final PacketType TYPE = PacketType.Configuration.Server.STORE_COOKIE;
