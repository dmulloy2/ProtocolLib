 ...
 * </ul>
 */
public class WrapperGameClientboundSpawnEntity extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SPAWN_ENTITY;

    public WrapperGameClientboundSpawnEntity() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSpawnEntity(PacketContainer packet) {
        super(packet, TYPE);
    }
