 ...
 * </ul>
 */
public class WrapperGameClientboundOpenBook extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.OPEN_BOOK;

    public WrapperGameClientboundOpenBook() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundOpenBook(PacketContainer packet) {
        super(packet, TYPE);
    }
