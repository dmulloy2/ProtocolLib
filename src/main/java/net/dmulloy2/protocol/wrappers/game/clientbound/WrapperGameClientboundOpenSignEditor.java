 ...
 * </ul>
 */
public class WrapperGameClientboundOpenSignEditor extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.OPEN_SIGN_EDITOR;

    public WrapperGameClientboundOpenSignEditor() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundOpenSignEditor(PacketContainer packet) {
        super(packet, TYPE);
    }
