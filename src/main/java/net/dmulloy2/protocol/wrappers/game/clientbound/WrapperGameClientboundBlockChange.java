 ...
 * </ul>
 */
public class WrapperGameClientboundBlockChange extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.BLOCK_CHANGE;

    public WrapperGameClientboundBlockChange() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundBlockChange(PacketContainer packet) {
        super(packet, TYPE);
    }
