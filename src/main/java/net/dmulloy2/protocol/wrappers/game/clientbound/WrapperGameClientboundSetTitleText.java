 ...
 * </ul>
 */
public class WrapperGameClientboundSetTitleText extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_TITLE_TEXT;

    public WrapperGameClientboundSetTitleText() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetTitleText(PacketContainer packet) {
        super(packet, TYPE);
    }
