 ...
 *   <li>{@code byte yaw} – packed yaw (use {@link WrapperGameClientboundSpawnEntity#angleToByte}
 *       / {@link WrapperGameClientboundSpawnEntity#byteToAngle} for conversion)</li>
 *   <li>{@code byte pitch} – packed pitch</li>
 *   <li>{@code boolean onGround} – whether the entity is on the ground</li>
 * </ul>
 */
public class WrapperGameClientboundEntityLook extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_LOOK;

    public WrapperGameClientboundEntityLook() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundEntityLook(PacketContainer packet) {
        super(packet, TYPE);
    }
