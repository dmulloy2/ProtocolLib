 ...
 * </ul>
 */
public class WrapperGameClientboundCloseWindow extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.CLOSE_WINDOW;

    public WrapperGameClientboundCloseWindow() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundCloseWindow(PacketContainer packet) {
        super(packet, TYPE);
    }
