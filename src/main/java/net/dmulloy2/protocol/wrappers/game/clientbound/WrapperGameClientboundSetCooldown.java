 ...
 * </ul>
 */
public class WrapperGameClientboundSetCooldown extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_COOLDOWN;

    public WrapperGameClientboundSetCooldown() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetCooldown(PacketContainer packet) {
        super(packet, TYPE);
    }
