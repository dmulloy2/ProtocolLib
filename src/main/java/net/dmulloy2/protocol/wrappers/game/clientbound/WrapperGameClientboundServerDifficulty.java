 ...
 * </ul>
 */
public class WrapperGameClientboundServerDifficulty extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SERVER_DIFFICULTY;

    public WrapperGameClientboundServerDifficulty() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundServerDifficulty(PacketContainer packet) {
        super(packet, TYPE);
    }
