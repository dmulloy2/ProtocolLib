 ...
 * </ul>
 */
public class WrapperGameClientboundSetBorderCenter extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_BORDER_CENTER;

    public WrapperGameClientboundSetBorderCenter() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetBorderCenter(PacketContainer packet) {
        super(packet, TYPE);
    }
