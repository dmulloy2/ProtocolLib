 ...
 * </ul>
 */
public class WrapperGameClientboundWorldEvent extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.WORLD_EVENT;

    public WrapperGameClientboundWorldEvent() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundWorldEvent(PacketContainer packet) {
        super(packet, TYPE);
    }
