 ...
 * </ul>
 */
public class WrapperGameClientboundUpdateSimulationDistance extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.UPDATE_SIMULATION_DISTANCE;

    public WrapperGameClientboundUpdateSimulationDistance() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundUpdateSimulationDistance(PacketContainer packet) {
        super(packet, TYPE);
    }
