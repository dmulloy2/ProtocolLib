 ...
 * </ul>
 */
public class WrapperGameClientboundAnimation extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ANIMATION;

    public WrapperGameClientboundAnimation() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundAnimation(PacketContainer packet) {
        super(packet, TYPE);
    }
