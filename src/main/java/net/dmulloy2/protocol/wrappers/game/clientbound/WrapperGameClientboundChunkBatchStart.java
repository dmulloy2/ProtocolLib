 ...
 */
public class WrapperGameClientboundChunkBatchStart extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.CHUNK_BATCH_START;

    public WrapperGameClientboundChunkBatchStart() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundChunkBatchStart(PacketContainer packet) {
        super(packet, TYPE);
    }
}
