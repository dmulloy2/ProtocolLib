...
public class WrappedServerboundEditBookPacket extends AbstractPacket {
    ...
    public void setPages(List<String> pages) {
        handle.getLists(Converters.passthrough(String.class)).write(0, pages);
    }

    public Optional<String> getTitle() {
        return handle.getOptionals(Converters.passthrough(String.class)).read(0);
    }

    public void setTitle(Optional<String> title) {
        handle.getOptionals(Converters.passthrough(String.class)).write(0, title);
    }
}
