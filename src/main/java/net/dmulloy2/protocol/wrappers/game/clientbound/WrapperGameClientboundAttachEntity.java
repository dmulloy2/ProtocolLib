 ...
 * </ul>
 */
public class WrapperGameClientboundAttachEntity extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ATTACH_ENTITY;

    public WrapperGameClientboundAttachEntity() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundAttachEntity(PacketContainer packet) {
        super(packet, TYPE);
    }
