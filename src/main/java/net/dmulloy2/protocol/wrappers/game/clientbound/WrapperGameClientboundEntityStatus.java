 ...
 * </ul>
 */
public class WrapperGameClientboundEntityStatus extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_STATUS;

    public WrapperGameClientboundEntityStatus() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundEntityStatus(PacketContainer packet) {
        super(packet, TYPE);
    }
