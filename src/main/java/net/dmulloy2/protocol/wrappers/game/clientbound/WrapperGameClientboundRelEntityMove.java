 ...
 */
public class WrapperGameClientboundRelEntityMove extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.REL_ENTITY_MOVE;

    public WrapperGameClientboundRelEntityMove() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundRelEntityMove(PacketContainer packet) {
        super(packet, TYPE);
    }
