 ...
 * </ul>
 */
public class WrapperGameClientboundGameStateChange extends AbstractPacket {
    ...
    public WrapperGameClientboundGameStateChange() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundGameStateChange(PacketContainer packet) {
        super(packet, TYPE);
    }
