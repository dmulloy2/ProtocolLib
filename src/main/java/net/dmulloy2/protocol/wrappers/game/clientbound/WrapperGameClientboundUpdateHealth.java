 ...
 * </ul>
 */
public class WrapperGameClientboundUpdateHealth extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.UPDATE_HEALTH;

    public WrapperGameClientboundUpdateHealth() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundUpdateHealth(PacketContainer packet) {
        super(packet, TYPE);
    }
