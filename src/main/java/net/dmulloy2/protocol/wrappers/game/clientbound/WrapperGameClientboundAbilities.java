 ...
 * </ul>
 */
public class WrapperGameClientboundAbilities extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ABILITIES;

    public WrapperGameClientboundAbilities() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundAbilities(PacketContainer packet) {
        super(packet, TYPE);
    }
