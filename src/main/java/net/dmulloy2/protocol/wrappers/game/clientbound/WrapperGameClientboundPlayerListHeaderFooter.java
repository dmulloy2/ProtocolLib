 ...
 * </ul>
 */
public class WrapperGameClientboundPlayerListHeaderFooter extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.PLAYER_LIST_HEADER_FOOTER;

    public WrapperGameClientboundPlayerListHeaderFooter() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundPlayerListHeaderFooter(PacketContainer packet) {
        super(packet, TYPE);
    }
