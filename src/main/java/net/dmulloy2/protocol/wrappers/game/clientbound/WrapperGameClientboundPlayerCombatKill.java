 ...
 * </ul>
 */
public class WrapperGameClientboundPlayerCombatKill extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.PLAYER_COMBAT_KILL;

    public WrapperGameClientboundPlayerCombatKill() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundPlayerCombatKill(PacketContainer packet) {
        super(packet, TYPE);
    }
