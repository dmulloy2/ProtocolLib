 ...
 * </ul>
 */
public class WrapperGameClientboundOpenWindowHorse extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.OPEN_WINDOW_HORSE;

    public WrapperGameClientboundOpenWindowHorse() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundOpenWindowHorse(PacketContainer packet) {
        super(packet, TYPE);
    }
