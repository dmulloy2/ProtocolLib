 ...
 * </ul>
 */
public class WrapperGameClientboundSetTitlesAnimation extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_TITLES_ANIMATION;

    public WrapperGameClientboundSetTitlesAnimation() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetTitlesAnimation(PacketContainer packet) {
        super(packet, TYPE);
    }
