 ...
 * </ul>
 */
public class WrapperGameClientboundEntityDestroy extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_DESTROY;

    public WrapperGameClientboundEntityDestroy() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundEntityDestroy(PacketContainer packet) {
        super(packet, TYPE);
    }
