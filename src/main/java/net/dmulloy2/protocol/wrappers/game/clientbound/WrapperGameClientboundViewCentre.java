 ...
 * </ul>
 */
public class WrapperGameClientboundViewCentre extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.VIEW_CENTRE;

    public WrapperGameClientboundViewCentre() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundViewCentre(PacketContainer packet) {
        super(packet, TYPE);
    }
