 ...
 * </ul>
 */
public class WrapperGameClientboundCollect extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.COLLECT;

    public WrapperGameClientboundCollect() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundCollect(PacketContainer packet) {
        super(packet, TYPE);
    }
