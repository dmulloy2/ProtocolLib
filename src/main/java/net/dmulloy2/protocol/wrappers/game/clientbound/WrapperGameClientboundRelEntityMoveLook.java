 ...
 * </ul>
 */
public class WrapperGameClientboundRelEntityMoveLook extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.REL_ENTITY_MOVE_LOOK;

    public WrapperGameClientboundRelEntityMoveLook() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundRelEntityMoveLook(PacketContainer packet) {
        super(packet, TYPE);
    }
