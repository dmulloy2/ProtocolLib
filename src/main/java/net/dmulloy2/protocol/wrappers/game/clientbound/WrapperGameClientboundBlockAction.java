 ...
 * </ul>
 */
public class WrapperGameClientboundBlockAction extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.BLOCK_ACTION;

    public WrapperGameClientboundBlockAction() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundBlockAction(PacketContainer packet) {
        super(packet, TYPE);
    }
