 ...
 * </ul>
 */
public class WrapperGameClientboundSetBorderSize extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_BORDER_SIZE;

    public WrapperGameClientboundSetBorderSize() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetBorderSize(PacketContainer packet) {
        super(packet, TYPE);
    }
