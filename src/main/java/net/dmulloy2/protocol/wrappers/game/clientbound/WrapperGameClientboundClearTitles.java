 ...
 * </ul>
 */
public class WrapperGameClientboundClearTitles extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.CLEAR_TITLES;

    public WrapperGameClientboundClearTitles() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundClearTitles(PacketContainer packet) {
        super(packet, TYPE);
    }
