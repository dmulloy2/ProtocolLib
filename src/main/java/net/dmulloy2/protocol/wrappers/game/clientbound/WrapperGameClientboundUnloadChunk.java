 ...
 * </ul>
 */
public class WrapperGameClientboundUnloadChunk extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.UNLOAD_CHUNK;

    public WrapperGameClientboundUnloadChunk() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundUnloadChunk(PacketContainer packet) {
        super(packet, TYPE);
    }
