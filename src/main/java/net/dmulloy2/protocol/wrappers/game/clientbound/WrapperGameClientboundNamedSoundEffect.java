 ...
 * </ul>
 */
public class WrapperGameClientboundNamedSoundEffect extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.NAMED_SOUND_EFFECT;

    public WrapperGameClientboundNamedSoundEffect() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundNamedSoundEffect(PacketContainer packet) {
        super(packet, TYPE);
    }
