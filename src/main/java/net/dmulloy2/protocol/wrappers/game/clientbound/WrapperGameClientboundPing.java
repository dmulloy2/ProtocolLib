 ...
 * </ul>
 */
public class WrapperGameClientboundPing extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.PING;

    public WrapperGameClientboundPing() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundPing(PacketContainer packet) {
        super(packet, TYPE);
    }
