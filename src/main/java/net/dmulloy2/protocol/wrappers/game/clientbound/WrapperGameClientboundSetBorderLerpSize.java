 ...
 * </ul>
 */
public class WrapperGameClientboundSetBorderLerpSize extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SET_BORDER_LERP_SIZE;

    public WrapperGameClientboundSetBorderLerpSize() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundSetBorderLerpSize(PacketContainer packet) {
        super(packet, TYPE);
    }
