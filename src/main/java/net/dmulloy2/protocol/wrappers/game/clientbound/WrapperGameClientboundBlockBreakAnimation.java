 ...
 * </ul>
 */
public class WrapperGameClientboundBlockBreakAnimation extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.BLOCK_BREAK_ANIMATION;

    public WrapperGameClientboundBlockBreakAnimation() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundBlockBreakAnimation(PacketContainer packet) {
        super(packet, TYPE);
    }
