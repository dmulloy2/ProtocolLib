 ...
 * </ul>
 */
public class WrapperGameClientboundWindowData extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.WINDOW_DATA;

    public WrapperGameClientboundWindowData() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundWindowData(PacketContainer packet) {
        super(packet, TYPE);
    }
