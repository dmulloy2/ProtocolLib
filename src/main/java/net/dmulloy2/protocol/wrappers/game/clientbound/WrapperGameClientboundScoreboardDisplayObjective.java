 ...
 * </ul>
 */
public class WrapperGameClientboundScoreboardDisplayObjective extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.SCOREBOARD_DISPLAY_OBJECTIVE;

    public WrapperGameClientboundScoreboardDisplayObjective() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundScoreboardDisplayObjective(PacketContainer packet) {
        super(packet, TYPE);
    }
