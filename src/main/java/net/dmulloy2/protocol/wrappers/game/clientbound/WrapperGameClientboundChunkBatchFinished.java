 ...
 * </ul>
 */
public class WrapperGameClientboundChunkBatchFinished extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.CHUNK_BATCH_FINISHED;

    public WrapperGameClientboundChunkBatchFinished() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundChunkBatchFinished(PacketContainer packet) {
        super(packet, TYPE);
    }
