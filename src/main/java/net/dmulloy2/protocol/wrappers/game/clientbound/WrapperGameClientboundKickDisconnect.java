 ...
 * </ul>
 */
public class WrapperGameClientboundKickDisconnect extends AbstractPacket {

    public static final PacketType TYPE = PacketType.Play.Server.KICK_DISCONNECT;

    public WrapperGameClientboundKickDisconnect() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperGameClientboundKickDisconnect(PacketContainer packet) {
        super(packet, TYPE);
    }
