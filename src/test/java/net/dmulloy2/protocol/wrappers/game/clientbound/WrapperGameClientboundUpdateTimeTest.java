...
class WrapperGameClientboundUpdateTimeTest {
    ...
    @Test
    void testCreate() {
        WrapperGameClientboundUpdateTime w = new WrapperGameClientboundUpdateTime();
    ...
    void testReadFromExistingPacket() {
        ...
        WrapperGameClientboundUpdateTime wrapper = new WrapperGameClientboundUpdateTime(container);
    ...
    void testWrongPacketTypeThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> new WrapperGameClientboundUpdateTime(
