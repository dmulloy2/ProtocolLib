...
class WrapperGameClientboundEntitySoundTest {
    ...
    @Test
    void testCreate() {
        WrapperGameClientboundEntitySound w = new WrapperGameClientboundEntitySound();
    ...
    void testReadFromExistingPacket() {
        ...
        WrapperGameClientboundEntitySound w = new WrapperGameClientboundEntitySound(raw);
    ...
    void testModifyExistingPacket() {
        ...
        new WrapperGameClientboundEntitySound(w.getHandle()).setVolume(0.5f);
    ...
    void testWrongPacketTypeThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> new WrapperGameClientboundEntitySound(
