...
class WrapperGameClientboundSetSubtitleTextTest {
    ...
    @Test
    void testCreate() {
        WrapperGameClientboundSetSubtitleText w = new WrapperGameClientboundSetSubtitleText();
    ...
    void testReadFromExistingPacket() {
        ...
        WrapperGameClientboundSetSubtitleText w = new WrapperGameClientboundSetSubtitleText(raw);
    ...
    void testModifyExistingPacket() {
        ...
        new WrapperGameClientboundSetSubtitleText(w.getHandle())
    ...
    void testWrongPacketTypeThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> new WrapperGameClientboundSetSubtitleText(
