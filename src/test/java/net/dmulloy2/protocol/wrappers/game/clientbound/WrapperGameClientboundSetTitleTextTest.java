...
class WrapperGameClientboundSetTitleTextTest {
    ...
    @Test
    void testCreate() {
        WrapperGameClientboundSetTitleText w = new WrapperGameClientboundSetTitleText();
    ...
    void testReadFromExistingPacket() {
        ...
        WrapperGameClientboundSetTitleText w = new WrapperGameClientboundSetTitleText(raw);
    ...
    void testModifyExistingPacket() {
        ...
        new WrapperGameClientboundSetTitleText(w.getHandle())
    ...
    void testWrongPacketTypeThrows() {
        assertThrows(IllegalArgumentException.class,
                () -> new WrapperGameClientboundSetTitleText(
