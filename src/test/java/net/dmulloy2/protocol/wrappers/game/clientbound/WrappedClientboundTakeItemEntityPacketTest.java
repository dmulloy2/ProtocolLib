...
class WrappedClientboundTakeItemEntityPacketTest {
    ...
    void testReadFromExistingPacket() {
        ...
        WrappedClientboundTakeItemEntityPacket w = new WrappedClientboundTakeItemEntityPacket(raw);
    ...
    void testModifyExistingPacket() {
        ...
        new WrappedClientboundTakeItemEntityPacket(w.getHandle()).setPickupItemCount(64);
