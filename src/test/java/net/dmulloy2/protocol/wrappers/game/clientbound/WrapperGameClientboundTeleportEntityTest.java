...
class WrapperGameClientboundTeleportEntityTest {
    ...
    @Test
    void testCreate() {
        WrapperGameClientboundTeleportEntity wrapper = new WrapperGameClientboundTeleportEntity();
    ...
    void testReadFromExistingPacket() {
        ...
        WrapperGameClientboundTeleportEntity wrapper = new WrapperGameClientboundTeleportEntity(raw);
    ...
    void testModifyExistingPacket() {
        ...
        WrapperGameClientboundTeleportEntity modified =
                new WrapperGameClientboundTeleportEntity(wrapper.getHandle());
    ...
    void testWrongPacketTypeThrows() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new WrapperGameClientboundTeleportEntity(wrong));
    }
}
