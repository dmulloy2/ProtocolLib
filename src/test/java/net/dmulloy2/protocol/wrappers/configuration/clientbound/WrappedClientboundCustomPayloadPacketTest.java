...
class WrappedClientboundCustomPayloadPacketTest {
    ...
    void testAllArgsCreate() {
        ...
        assertEquals(PacketType.Configuration.Server.CUSTOM_PAYLOAD, w.getHandle().getType());
    ...
    void testModifyExistingPacket() {
        ...
        CustomPacketPayloadWrapper newPayload = new CustomPacketPayloadWrapper(new byte[]{4, 5, 6}, new MinecraftKey("test", "modified"));
        wrapper.setPayload(newPayload);
